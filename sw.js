...
const CACHE_NAME = 'cookbook-v12-offline';
...
const ASSETS_TO_CACHE = [
  ...
  '/admin-recipe-list.html',
  '/admin-scan.html',
  '/admin-import.html',
  '/admin-upload.html',
  '/admin-drive-sync.html',
  '/admin-usage.html',
  '/admin-popular.html',
  '/admin-activity.html',
  '/leaderboard.html',
  ...
  '/scripts/print.js',
  '/scripts/review.js',
  '/scripts/invite-signup.js',
  '/scripts/ingredient-utils.js',
  '/scripts/recipe-model.js',
  '/scripts/household.js',
  '/scripts/recipe-import.js',
  '/scripts/drive-sync-trigger.js',
  '/scripts/swipe.js',
