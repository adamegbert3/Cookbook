export const mainDishRecipes = [
  ...
  },
  {
    ...
    recipeInstructions: [
      ...
      "Marinade for a few hours or overnight. Drain marinade and put pork, ½ can of coke, water, and garlic salt in crockpot on high for 3-4 hours (or until it shreds easily) or on low for 8 hours.",
      "Remove pork from crock pot and drain any liquid left in the pot. Shred pork.",
      "In a food processor or blender, blend ½ can Coke, chilies, enchilada sauce and remaining brown sugar.",
  ...
  },
  {
    ...
    recipeInstructions: [
      "Preheat the oven to 350º. Cook macaroni according to directions.",
  ...
  },
  {
    ...
    recipeIngredient: [
      ...
      "1 lbs hamburger",
      "½ -¾ cups salsa",
      "Toppings: Lettuce, Cheese, Sour cream, Salsa, Ranch dressing"
    ],
    recipeInstructions: [
  ...
  },
  {
    ...
    recipeInstructions: [
      ...
      "NOTE: Leftovers are best when you add a splash of milk after it is reheated, but only then. DO NOT substitute it for the heavy cream or you will get a curdled mess and a lot of wasted food."
    ]
  },
  {
    author: "",
    ...
    recipeInstructions: [
      ...
      "Cover and cook for 45 minutes to one hour. When meat is tender, bring each piece to the top and cover with a slice of mild cheddar cheese.",
  ...
  },
  {
    ...
    recipeInstructions: [
      "Pie Crust: Measure flour and salt. Cut in shortening. Sprinkle with water 1 T. at a time, mixing until all flour is moistened and dough almost cleans side of bowl. Gather dough into ball. Roll dough 2 inches larger than inverted pie pan. Ease into pan.",
